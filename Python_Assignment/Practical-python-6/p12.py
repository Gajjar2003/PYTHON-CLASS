...
string1 = "well come to be python program it !"
print(string1)
...
string2 = """hello world
             well come to be python program it 
             to be start 8 aug 2025 """
...
my_string = "well come to be python !"
sub = my_string[1:4]
print(sub)
